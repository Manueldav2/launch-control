...
export function PlatformGlyph({ p, size = 14 }: { p: string; size?: number }) {
  ...
  if (p === "tiktok") return <svg viewBox="0 0 24 24" {...c}><path d="M16.5 2c.3 2.3 1.6 3.9 3.9 4.1v2.7c-1.4.1-2.7-.3-3.9-1v6.6c0 3.6-2.6 5.9-5.7 5.6-3-.3-4.9-2.9-4.4-5.9.4-2.4 2.4-4 4.8-3.9.3 0 .6.1.9.1v2.8c-.3-.1-.6-.2-1-.2-1.2 0-2.1 1-2 2.2.1 1.1 1 1.9 2.1 1.8 1.2-.1 1.9-1 1.9-2.2V2h3.4z"/></svg>;
  if (p === "luma") return <svg viewBox="0 0 24 24" {...c}><circle cx="12" cy="12" r="7"/></svg>;
